async page => {
  ...
  const assertions = [{"type": "text", "selector": ".sandbox-detail-header", "expected": "Paused"}, {"type": "text", "selector": "#navigation-title", "expected": "default-pool"}, {"type": "text", "selector": "[data-terminal-overlay]", "expected": "must be running"}];
  const results = [];

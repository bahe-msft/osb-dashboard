async page => {
  ...
  const assertions = [{"type": "count", "selector": ".icon-card", "expected": 60}, {"type": "count", "selector": ".icon-card svg", "expected": 60}, {"type": "text", "selector": ".iconography", "expected": "terminal-square"}];
  const results = [];

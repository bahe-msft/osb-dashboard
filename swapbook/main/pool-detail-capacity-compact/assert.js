async page => {
  ...
  const assertions = [{"type": "text", "selector": "#dashboard-content", "expected": "At capacity"}, {"type": "count", "selector": ".pool-sandbox-row", "expected": 2}, {"type": "attribute", "selector": "[data-deploy-pool]", "expected": "", "attribute": "disabled"}];
  const results = [];

async page => {
  ...
  const assertions = [{"type": "count", "selector": ".sandbox-row", "expected": 3}, {"type": "visible", "selector": "[data-sandbox-state=paused]"}, {"type": "visible", "selector": "[data-sandbox-state=failed]"}];
  const results = [];
